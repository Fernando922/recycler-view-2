package br.com.dipaulamobilesolutions.ceep.ui.recyclerview.helper.callback;
...
public class NotaItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        int posicaoDaNotaDesejada = viewHolder.getAdapterPosition();
        removeNota(posicaoDaNotaDesejada);
    }
